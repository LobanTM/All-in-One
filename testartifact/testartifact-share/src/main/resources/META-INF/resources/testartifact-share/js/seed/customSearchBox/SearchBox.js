  ...
  define(["dojo/_base/declare",
     ...
     var LiveSearch = declare([_Widget, _Templated, AlfCore], {
        ...
        /**
         * DOM element container for Folders
         * 
         * @instance
         * @type {object}
         */
        containerNodeFolders: null,
     ...
     return declare([_Widget, _Templated, CoreXhr, TemporalUtils, FileSizeMixin], {
        ...
        processLiveSearchDocument: function alfresco_header_SearchBox__processLiveSearchDocument(item) {
           ...
           switch (item.container){
           	...
           	case "blog":
           		...
           		break;
           	case "folder":
           		//link = "folder-details?nodeRef=" + item.nodeRef;
           		link = "context/shared/sharedfiles#filter=" + encodeURIComponent(item.path);
           		//item.name = item.title;
           		break;
           	default:
           ...
           if(item.container == "folder"){
             this.alfLog("log", "Folder link: ", link);
             ...
             icon: AlfConstants.URL_RESCONTEXT + "components/images/filetypes/generic-folder-32.png",
             alt: item.name,
             meta: info,
             meta2: info2,
        ...
        processLiveSearchPerson: function alfresco_header_SearchBox__processLiveSearchPerson(item) {
           ...
           var meta2 = (item.telephone || "") + (item.location ? ((item.email ? ", " : "") + item.location) : "")+ (item.telephone || "");
